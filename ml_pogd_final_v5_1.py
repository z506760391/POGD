"""
POGD Prediction Model v5.1 — Fully Patched Version
New Fixes (vs. v5.0):
  🔴 Tkinter multi-threading error fix: Force matplotlib.use('Agg') at the first line.
  🟢 Chinese progress prompts throughout the process.
  🟢 All chart titles are now bilingual (Chinese-English) to support environments without Chinese fonts.
Fix List (vs. v4.6):
...
print("=" * 120)
print("POGD Clinical Prediction Model v5.1 (Fully Patched)".center(120))
print("=" * 120)
